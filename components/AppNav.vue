...
<template>
  <nav
    class="flex-col justify-center items-center rounded-xl p-[.375rem] md:px-4 text-gray-900 dark:text-gray-200 md:w-full w-32 md:max-h-64 max-h-16 md:right-0 md:bottom-0 fixed md:relative bottom-6 right-4 bg-gray-100/75 dark:bg-gray-900/75 md:bg-transparent dark:md:bg-transparent z-50 origin-bottom-right backdrop-blur-xl md:backdrop-blur-none print:hidden"
