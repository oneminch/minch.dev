...
<template>
  <NuxtLink
    ...
    class="w-full h-48 relative border border-slate-300 dark:border-slate-700 bg-cover bg-center rounded-lg overflow-hidden p-4 flex flex-col justify-between last:[&>*]:mb-0 [&>*]:mb-2 mb-5 bg-no-repeat hover:scale-105 duration-200 transition-all ease-linear"
    :to="url"
  >
