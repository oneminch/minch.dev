...
<template>
  <nuxt-link
    :to="projectUrl"
    class="relative flex items-center w-full h-24 p-4 overflow-hidden duration-200 bg-white border focused-link rounded-xl transition- border-zinc-200 dark:border-zinc-700 dark:bg-zinc-800/50 hover:ring-2 hover:ring-offset-0 hover:ring-green-400 hover:ring-opacity-75"
  >
    <div
