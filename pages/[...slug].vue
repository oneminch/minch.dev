<template>
  <section class="w-full">
    ...
    >
      <!-- Breadcrumb nav menu -->
      <nav
        class="flex items-center mb-6 py-2 px-4 rounded-lg text-lg [&>*]:mr-4 border border-1 border-slate-300"
      >
        <NuxtLink
          class="breadcrumb-nav focused-link dark:text-slate-200 hover:before:visible before:invisible relative -z-0 no-underline"
          to="/"
          >Home</NuxtLink
        >
