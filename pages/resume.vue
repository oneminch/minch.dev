      ...
      <div class="mb-1" v-for="(skills, category) in skillset" :key="category">
        ...
        <ul class="inline-block p-0">
          <li
            ...
            :key="skill"
            class="font-bold px-3 py-[.125rem] inline-block dark:border-2 dark:border-green-500 bg-green-300 dark:bg-transparent text-zinc-800 dark:text-green-500 rounded-full text-sm mr-1 mb-1"
          >
            {{ skill }}
          </li>
        </ul>
