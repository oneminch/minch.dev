<template>
  <main class="w-full">
    ...
    <!-- Blog Content -->
    <article
      class="w-full max-w-3xl prose lg:prose-base dark:prose-invert prose-img:rounded-lg prose-slate prose-a:no-underline prose-a:border-b-[1.5px] prose-a:border-b-green-400 prose-pre:bg-zinc-700 prose-code:leading-snug prose-code:font-normal prose-code:bg-zinc-700 prose-code:text-zinc-100 prose-code:px-2 prose-code:py-0 prose-code:inline-block prose-code:rounded-md prose-code:before:content-none prose-code:after:content-none mx-auto text-zinc-800 dark:text-zinc-100"
    >
      <slot />
    </article>
  </main>
